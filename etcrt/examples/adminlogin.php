...
{
   if($_POST["email"]=="admin_giris@gmail.com" && $_POST["pass"]==12345678)
   {
   ...
   {
     echo"<script>alert('Geçerli Bir E-posta veya Şifre Giriniz')</script>";
   }
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" method="POST">
                ...
                <div class="text-center">
                  <button target="_blank"  href="Page-3.php" class="btn btn-primary my-4">Sign in</button>
                </div>
              </form>
            </div>
          </div>
