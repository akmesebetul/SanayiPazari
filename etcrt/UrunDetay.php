		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-6 product-details">
					<h2 class="p-title"><?php echo $Urun["productName"] ?></h2>
					...
					<a href="teklifver.php" class="site-btn">Teklif Ver</a>
						...
						<div class="panel">
							...
							<div id="collapse1" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
								<div class="panel-body">
									<?php echo $Urun["productDescription"] ?>
								</div>
							</div>
						</div>
						<div class="panel">
							<div class="panel-header" id="headingTwo">
								<button class="panel-link" data-toggle="collapse" data-target="#collapse2" aria-expanded="false" aria-controls="collapse2">Ürün Özellikleri </button>
							</div>
							<div id="collapse2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
								<div class="panel-body">
									<?php echo $Urun["productSubDescription"]?>
								</div>
							</div>
						</div>
						<div class="panel">
