...
include "../baglanti.php";
 $Urunler=$db->query("SELECT * FROM products ORDER BY productName");
 $Urunler->execute();                         
 $Urun=$Urunler->fetchAll(PDO::FETCH_OBJ);
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                      ...
                      <tbody>
                        <?php 
                          ...
                          <tr>
                          <td><a href="UrunDty.php?id=<?$Urun->id] ?>">Ürün Detay </a></td>
                          <td><a href="Teklifler.php?id=<?$Urun->id] ?>">Teklifler </a></td>
                          <td><?=$Urun->categoryId ?></td>
                          <td><?= $Urun->productName ?></td>
                          <td><?= $Urun->offerCreateTime ?></td>
                          <td><?= $Urun->offerFinishedTime ?></td>
                        </tr>
                     <?php
                     }
                    ?>
